...
export const MasonryBlock = ({ appBridge }: BlockProps): ReactElement => {
	...
	const handleContentChange = (id: string, content: string) => {
		...
		}).catch(() => console.error("Couldn't save the block settings"));
	};
			...
			<DragAndDropSortableContext items={masonryItems} strategy="rect-swapping" onDragEnd={handleDragEnd}>
				<Masonry
					columnCount={Number.parseInt(
						blockSettings.columnsCountCustomEnabled ? blockSettings.columnsCountCustom : blockSettings.columnsCountSimple,
						10,
					)}
				>
