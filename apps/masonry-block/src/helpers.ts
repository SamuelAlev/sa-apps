...
export const isLastMasonryItemEmpty = (masonryItems: MasonryItem[], blockAssets: ReturnType<typeof useBlockAssets>['blockAssets']) =>
    isMasonryItemEmpty(masonryItems[masonryItems.length - 1], blockAssets);

export const isMasonryItemEmpty = (masonryItem: MasonryItem, blockAssets: ReturnType<typeof useBlockAssets>['blockAssets']) =>
...
export const getMasonryRootStyles = (blockSettings: BlockSettings) =>
    ({
        '--masonry-items-gap': blockSettings.itemsGapCustomEnabled ? blockSettings.itemsGapCustom : blockSettings.itemsGapSimple,

        '--masonry-item-content-padding-top': blockSettings.itemContentPaddingCustomEnabled ? blockSettings.itemContentPaddingTop : blockSettings.itemContentPaddingSimple,
        '--masonry-item-content-padding-right': blockSettings.itemContentPaddingCustomEnabled ? blockSettings.itemContentPaddingRight : blockSettings.itemContentPaddingSimple,
        '--masonry-item-content-padding-bottom': blockSettings.itemContentPaddingCustomEnabled ? blockSettings.itemContentPaddingBottom : blockSettings.itemContentPaddingSimple,
        '--masonry-item-content-padding-left': blockSettings.itemContentPaddingCustomEnabled ? blockSettings.itemContentPaddingLeft : blockSettings.itemContentPaddingSimple,
        ...
        '--masonry-items-border-color': blockSettings.itemsBorderColor ? rgbaObjectToString(blockSettings.itemsBorderColor) : undefined,
