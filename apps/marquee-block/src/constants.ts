...
export const borderRadiusClasses =
	"rounded-tl-[var(--border-radius-top-left)] rounded-tr-[var(--border-radius-top-right)] rounded-bl-[var(--border-radius-bottom-left)] rounded-br-[var(--border-radius-bottom-right)]";
