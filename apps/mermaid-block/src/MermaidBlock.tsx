		...
		<div data-test-id="mermaid-block" className="mermaid-block w-full flex flex-col gap-6" style={getMermaidRootStyle(blockSettings)}>
			{isEditing ? (
					...
					<ResizeWrapper>
						<div className="relative">
							<pre
								...
								className={cn(
									"h-full w-full [&>svg]:!max-w-full [&>svg]:!w-full [&>svg]:h-full aspect-auto",
									borderClasses,
				...
				<div className="flex flex-col w-full group" data-show-code={blockSettings.alwaysShowCode || showCode}>
					<div
						style={{ height: blockSettings.height }}
						className={cn("relative w-full flex items-center justify-center", borderClasses)}
					>
						<div
