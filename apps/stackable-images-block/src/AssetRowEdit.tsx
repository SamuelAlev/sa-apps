    ...
    return (
        <div className="flex relative">
            <div className="grid w-full gap-6 items-center grid-cols-[140px_minmax(200px,1fr)] h-48">
                {/* biome-ignore lint/a11y/noRedundantAlt: description */}
                <img draggable={false} className="h-full w-full object-contain" src={prepareImageUrl(asset.previewUrl)} alt="layer for the stackable image" />
