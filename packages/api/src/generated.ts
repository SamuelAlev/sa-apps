...
export type AddAssetRelationsInput = {
  ...
  relatedAssetIds: Array<InputMaybe<Scalars['ID']>>;
};
...
export type AssetAttachmentDownloadUrlArgs = {
  ...
  validityInDays?: InputMaybe<Scalars['Int']>;
};
...
export type AssetQueryFilterConditionInput = {
  ...
  metadataFieldId?: InputMaybe<Scalars['ID']>;
...
export type Audio = Asset & Node & {
  ...
  licenses?: Maybe<Array<Maybe<License>>>;
  /** `MetadataValue` items linked to `Asset`. */
  metadataValues?: Maybe<Array<Maybe<MetadataValue>>>;
...
export type BlockAttachment = Attachment & Node & {
  ...
  assetId: Scalars['ID'];
  /**
   * **DEPRECATED** Id of the `Block` `Attachment`. This field will be removed. | Date: 2022-07-01T00:00:00.000+00:00
   * @deprecated This field will be removed. | Date: 2022-07-01T00:00:00.000+00:00
   */
  blockId: Scalars['ID'];
  /** `DateTime` of the `Attachment` creation. */
  ...
  creator: User;
  /**
   * **DEPRECATED** Id of the `Document` `Attachment`. This field will be removed. | Date: 2022-07-01T00:00:00.000+00:00
   * @deprecated This field will be removed. | Date: 2022-07-01T00:00:00.000+00:00
   */
  ...
  name?: Maybe<Scalars['String']>;
  /**
   * **DEPRECATED** Id of the `Portal` `Attachment`. This field will be removed. | Date: 2022-07-01T00:00:00.000+00:00
   * @deprecated This field will be removed. | Date: 2022-07-01T00:00:00.000+00:00
   */
  portalId: Scalars['ID'];
  /** Size of the `Attachment` `File` in bytes. */
...
export type BrandProjectsArgs = {
  types?: InputMaybe<Array<InputMaybe<Project_Type>>>;
};
...
export type CreateAssetInput = {
  ...
  directory?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  ...
  skipFileMetadata?: InputMaybe<Scalars['Boolean']>;
  ...
  workflowStatus?: InputMaybe<Scalars['String']>;
};
...
export type CreateCopyrightInput = {
  /** Create asset copyright notice. Supports medium text length (16 MB). */
  notice?: InputMaybe<Scalars['String']>;
  /** Create asset copyright status. */
  status?: CopyrightStatus;
};
...
export type CreateExternalAssetInput = {
  ...
  allowInteractions?: InputMaybe<Scalars['Boolean']>;
...
export type CreateLicenseInput = {
  ...
  addByDefault?: InputMaybe<Scalars['Boolean']>;
  /** `License` terms. */
  license: Scalars['String'];
  /** `Library` Id. */
  projectId: Scalars['ID'];
  /** Require user to accept `License` terms before download. */
  requireConsensus?: InputMaybe<Scalars['Boolean']>;
  /** `License` title. */
  title: Scalars['String'];
};
...
export type CreateMetadataFieldInput = {
  ...
  allowEmptyValue?: InputMaybe<Scalars['Boolean']>;
  /** Allow multiple values in `SELECT` type `Metadata Field`. */
  allowMultipleValues?: InputMaybe<Scalars['Boolean']>;
...
export type Library = {
  ...
  licenses?: Maybe<Array<Maybe<License>>>;
  /** Retrieve list of all `MetadataFields` belonging to this `Library`. */
  metadataFields?: Maybe<Array<Maybe<MetadataField>>>;
  /** `Library` name. */
  name: Scalars['String'];
};
...
export type MarkingTimeframeInput = {
  ...
  end?: InputMaybe<Scalars['Percent']>;
  ...
  start?: InputMaybe<Scalars['Percent']>;
};
...
export type MetadataField = {
  ...
  allowEmptyValue: Scalars['Boolean'];
...
export type RgbaColor = {
  ...
  /** Alpha channel value. */
  alpha: Scalars['Percent'];
  /** Blue color channel value. */
  blue: Scalars['RgbColorChannel'];
  /** Green color channel value. */
  green: Scalars['RgbColorChannel'];
  /** Red color channel value. */
  red: Scalars['RgbColorChannel'];
};
...
export type RootMutation = {
  ...
  /** Add a new relation between an existing `Asset` and an existing `MetadataField` with its value. The value will be automatically created and linked to its `MetadataField`. Requires `basic:write` scope to be accessible and `Asset` permission level `EDIT`. */
  ...
  /** Create a new `Project` `MetadataField` with your desired configuration. Requires `basic:write` scope to be accessible and `Project` permission level `EDIT`. */
  ...
  /** Delete an existing `Project` `MetadataField`. Existing `MetadataField`'s with the same value with be automatically removed. Requires `basic:write` scope to be accessible and `Project` permission level `EDIT`. */
  ...
  /** Remove existing `MetadataField` value.Existing relations to that `MetadataField` with the same value will be automatically removed.Requires `basic:write` scope to be accessible and `Asset` permission level `EDIT`. */
...
export type CurrentUserQuery = { __typename?: 'RootQuery', currentUser: { __typename?: 'User', id: string, email: any, avatar?: any | null, name?: string | null } };
